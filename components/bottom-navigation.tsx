...
export default function BottomNavigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-lg border-t border-gray-200 px-4 py-2 z-50 shadow-lg">
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center py-2 px-3 rounded-xl transition-all duration-300 ${
                isActive
                  ? "text-lime-700 bg-lime-200 scale-110 shadow-md"
